    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller0_AA1.yaml"),
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller1_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller2_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller3_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            PythonLaunchDescriptionSource(os.path.join(
                                mwsn_dir, 'launch', 'robot_controller_launch.py')),
                            launch_arguments={
                                'namespace': 'controller4',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller4_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            PythonLaunchDescriptionSource(os.path.join(
                                mwsn_dir, 'launch', 'robot_controller_launch.py')),
                            launch_arguments={
                                'namespace': 'controller5',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller5_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            PythonLaunchDescriptionSource(os.path.join(
                                mwsn_dir, 'launch', 'robot_controller_launch.py')),
                            launch_arguments={
                                'namespace': 'controller6',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller6_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            PythonLaunchDescriptionSource(os.path.join(
                                mwsn_dir, 'launch', 'robot_controller_launch.py')),
                            launch_arguments={
                                'namespace': 'controller7',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller7_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            PythonLaunchDescriptionSource(os.path.join(
                                mwsn_dir, 'launch', 'robot_controller_launch.py')),
                            launch_arguments={
                                'namespace': 'controller8',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller8_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            PythonLaunchDescriptionSource(os.path.join(
                                mwsn_dir, 'launch', 'robot_controller_launch.py')),
                            launch_arguments={
                                'namespace': 'controller9',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller9_AA1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    instances.append(
        Node(
            ...
            parameters=[
                ...
                'pose_file': '/home/borja/ros2/ros2_ws/src/ros2_agents/sim/poses_100_robots.yaml',}],
        ))
