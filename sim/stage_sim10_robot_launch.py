...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(mwsn_dir, 'maps', 'newsim10v3.world'),
...
# NAV2 Localization: 1 map server for each robot.
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot0',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot0.yaml"),
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot1',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot1.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot2',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot2.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot3',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot3.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot4',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot4.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot5',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot5.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot6',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot6.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot7',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot7.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot8',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot8.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                'namespace': 'robot9',
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_robot9.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    instances.append(
        Node(
            ...
            parameters=[
                {'number_of_robots': 10,
                'pose_file': '/home/borja/ros2/ros2_ws/src/ros2_agents/sim/poses_10_robots.yaml',}],
        ))
