...
def generate_launch_description():
    ...
    declare_bag_path_cmd = DeclareLaunchArgument(
        'bag_path',
        default_value=os.path.join('/home/borja/ros2/bags', 'fc_sigma2_25_controlledSim', 'ext_3_robot', datetime.now().strftime("%d_%m_%Y_%H:%M:%S")),
    ...
    robots = [
        ...
        {'name': 'robot2', 'x_pose': -0.4000, 'y_pose': 0.6928,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 2.0944},
        {'name': 'robot3', 'x_pose': -0.4000, 'y_pose': -0.6928,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 4.1888},
        ]
