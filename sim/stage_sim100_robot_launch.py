    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller2.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller3.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller4.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller5.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller6.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller7.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ...
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller8.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
    ld.add_action(
        IncludeLaunchDescription(
                            ...
                            launch_arguments={
                                ...
                                'log_level': 'info',
                                'config': os.path.join(mwsn_dir, 'config', f"parameters_controller9.yaml"),
                                'localization': 'GroundTruth',
                            }.items())
    )
