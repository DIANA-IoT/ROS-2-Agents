...
def generate_launch_description():
    ...
    declare_bag_path_cmd = DeclareLaunchArgument(
        'bag_path',
        default_value=os.path.join('/home/borja/ros2/bags', 'fc_sigma2_25_controlledSim', 'ext_10_robot', datetime.now().strftime("%d_%m_%Y_%H:%M:%S")),
    ...
    robots = [
        ...
        {'name': 'robot2', 'x_pose': 0.6472, 'y_pose': 0.4702,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 0.6283},
        {'name': 'robot3', 'x_pose': 0.2472, 'y_pose': 0.7608,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 1.2566},
        {'name': 'robot4', 'x_pose': -0.2472, 'y_pose': 0.7608,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 1.8850},
        {'name': 'robot5', 'x_pose': -0.6472, 'y_pose': 0.4702,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 2.5133},
        {'name': 'robot6', 'x_pose': -0.8000, 'y_pose': 0.0000,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 3.1416},
        {'name': 'robot7', 'x_pose': -0.6472, 'y_pose': -0.4702,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 3.7699},
        {'name': 'robot8', 'x_pose': -0.2472, 'y_pose': -0.7608,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 4.3982},
        {'name': 'robot9', 'x_pose': 0.2472, 'y_pose': -0.7608,'z_pose': 0.0, 
            'roll': 0.0, 'pitch': 0.0, 'yaw': 5.0265},
        {'name': 'robot10', 'x_pose': 0.6472, 'y_pose': -0.4702,'z_pose': 0.0, 
